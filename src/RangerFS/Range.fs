...
module Range = 
    ...
    let inline internal add a b = combine (+) a b            
    let inline internal sub a b = combine (-) a b            
    let inline internal mul a b = combine (*) a b
    let inline internal div a b = combine (/) a b
